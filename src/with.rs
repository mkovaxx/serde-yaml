...
/// #[derive(Serialize, Deserialize, PartialEq, Debug)]
/// struct Struct {
///     #[serde(with = "serde_yaml_ok::with::singleton_map")]
///     w: Enum,
///     #[serde(with = "serde_yaml_ok::with::singleton_map")]
///     x: Enum,
///     #[serde(with = "serde_yaml_ok::with::singleton_map")]
...
///     };
///
///     let yaml = serde_yaml_ok::to_string(&object).unwrap();
///     print!("{}", yaml);
///
///     let deserialized: Struct = serde_yaml_ok::from_str(&yaml).unwrap();
...
///     tagged_style: Inner,
///
///     #[serde(with = "serde_yaml_ok::with::singleton_map_recursive")]
...
///     print!("{}", yaml);
///
///     let deserialized: Outer = serde_yaml_ok::from_str(&yaml).unwrap();
///     assert_eq!(object, deserialized);
/// }
/// ```
///
...
///
///     let mut buf = Vec::new();
///     let mut serializer = serde_yaml_ok::Serializer::new(&mut buf);
///     serde_yaml_ok::with::singleton_map_recursive::serialize(&object, &mut serializer).unwrap();
///     io::stdout().write_all(&buf).unwrap();
///
///     let deserializer = serde_yaml_ok::Deserializer::from_slice(&buf);
///     let deserialized: Inner = serde_yaml_ok::with::singleton_map_recursive::deserialize(deserializer).unwrap();
///     assert_eq!(object, deserialized);
/// }
/// ```
