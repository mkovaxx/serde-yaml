//! [![github]](https://github.com/mkovaxx/serde-yaml)&ensp;[![crates-io]](https://crates.io/crates/serde-yaml)&ensp;[![docs-rs]](https://docs.rs/serde-yaml)
//!
...
pub use crate::ser::{to_string, to_writer, Serializer, SerializerConfig};
#[doc(inline)]
